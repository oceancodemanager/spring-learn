...
public class MyClassLoader3 extends ClassLoader {
	...
	// String className = "com.ocean.learn.spring.test.classLoder.InitValue";

	public MyClassLoader3() {
	}

	public MyClassLoader3(String classPath) {
